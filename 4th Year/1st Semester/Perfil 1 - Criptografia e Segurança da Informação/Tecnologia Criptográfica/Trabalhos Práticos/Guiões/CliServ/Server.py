...
from OpenSSLWorker import verifySignature, signingMessage, sPrivateKey, certVerify, verifySubject
...
def handle_echo(reader, writer):
    ...
    if certVerify(1):
        ...
        # Verificação da parte do Subject no certificado X509 do Cliente.
        if verifySubject(1):
            print("Este certificado é do subject Cliente, logo correto.")
            ...
            sys.exit("O certificado não é do subject Cliente.")
