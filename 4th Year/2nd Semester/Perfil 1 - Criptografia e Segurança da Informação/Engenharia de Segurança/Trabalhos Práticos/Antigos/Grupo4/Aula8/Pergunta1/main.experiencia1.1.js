...
koreCoin.addBlock(new Block (3, "10/02/2019", [{amount1: 100},{amount2: 200}]));
koreCoin.addBlock(new Block (3, "10/02/2019", [{amount1: 25},{amount2: 600},{amount3: 500}]));
koreCoin.addBlock(new Block (3, "10/02/2019", [{amount1: 10},{amount2: 30,{amount3: 50}]));

console.log('Is Blockchain valid? ' + koreCoin.isChainValid());

//tampering with blockchain
koreCoin.chain[1].data = { amount: 20 };
